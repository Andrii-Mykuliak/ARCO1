...
\caption{Operational criteria for the four cross-register correspondence outcomes.}
\label{tab:corrclasses}
\setlength{\tabcolsep}{5pt}
\begin{tabular}{>{\raggedright\arraybackslash}p{0.097\linewidth}>{\raggedright\arraybackslash}p{0.606\linewidth}>{\raggedright\arraybackslash}p{0.211\linewidth}}
\toprule
