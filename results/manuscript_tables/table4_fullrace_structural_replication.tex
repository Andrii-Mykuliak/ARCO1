...
\caption{Independent full-race structural replication and cross-register correspondence.}
\label{tab:fullrace}
\setlength{\tabcolsep}{5pt}
\begin{tabular}{>{\raggedright\arraybackslash}p{0.160\linewidth}>{\raggedright\arraybackslash}p{0.776\linewidth}}
\toprule
Quantity & Value \\
\midrule
